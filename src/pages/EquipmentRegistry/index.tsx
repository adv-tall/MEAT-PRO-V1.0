...
export default function EquipmentRegistry() {
    ...
    return (
        <div className="flex flex-1 w-full flex-col animate-fadeIn bg-transparent space-y-4">
            ...
            <DraggableModal isOpen={csvModalOpen} onClose={() => setCsvModalOpen(false)} title="Bulk Upload Equipment" width="max-w-2xl">
                <CsvUpload 
                    onUpload={(data) => {
                                ...
                                <div className="flex gap-3 w-full md:w-auto items-center">
                                    ...
                                    {activeTab === 'equipment' ? (
                                        <>
                                            ...
                                            <CsvExport data={equipment} filename="equipment_registry.csv" label="Export" className="bg-white border border-[#eaeaec] hover:border-[#4d87a8] hover:text-[#4d87a8] text-[#7a8b95] px-4 py-2 rounded-xl font-bold text-[12px] uppercase tracking-widest flex items-center gap-2 shadow-sm transition-colors hidden md:flex h-10" />
